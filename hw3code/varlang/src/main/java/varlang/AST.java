...
public interface AST {
	...
	public static class DefExp extends Exp {
		...
		public DefExp(List<String> names, List<Exp> value_exps) {
			_names = names;
			_value_exps = value_exps;
		}
	...
	public static class LeteExp extends Exp {
		...
		public LeteExp(List<String> names, List<Exp> value_exps, Exp key, Exp body) {
			_names = names;
			_value_exps = value_exps;
			_body = body;
			_key = key;
	...
	public static class DecExp extends Exp {
		...
		public DecExp(List<String> names, List<Exp> value_exps, Exp body) {
			_names = names;
			_value_exps = value_exps;
			_body = body;
		}
